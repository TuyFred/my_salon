...
<head>
    ...
    <title>Manage Services - Hair Saloon</title>
...
<body>
    ...
    <div class="sidebar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="fas fa-concierge-bell"></i> Manage Services</a>
            </li>
            <li class="nav-item">
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="add_services.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus"></i> Add Service</a>
    ...
    <i class="fas fa-download fa-sm text-white-50"></i> Generate Report
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="get" action="manage-services.jsp">
                        <div class="form-group">
                            <input type="text" class="form-control" name="search" placeholder="Search by service name..." value="<%= request.getParameter("search") %>">
                        </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= duration %></td>
                                    <td>
                                    	<button class="btn btn-info btn-sm" onclick="location.href='update_services.jsp?service_id=<%= service_id %>'"><i class="fas fa-edit"></i> Edit</button>
                                    	<button class="btn btn-danger btn-sm" onclick="location.href='delete_services.jsp?service_id=<%= service_id %>'"><i class="fas fa-trash-alt"></i> Delete</button>
                                    </td>
                                </tr>
                                <%
                                        }
