...
<head>
    ...
    <title>Update Staff - Action</title>
    ...
    <div class="container my-5">
        <div class="alert alert-info">
            <%
                ...
                try {
                    String query = "UPDATE staff SET staff_name = ?, position = ?, contact_number = ? WHERE s_id = ?";
                    ...
                    if (rowCount > 0) {
                        out.println("Staff member updated successfully.");
                    } else {
                        out.println("Error updating staff member.");
                    }
                    pstmt.close();
